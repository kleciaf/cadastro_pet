...
class PacientesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paciente" do
    assert_difference('Paciente.count') do
      post pacientes_url, params: { paciente: { cpf_cnpj_dono: @paciente.cpf_cnpj_dono, foto: @paciente.foto, nome_animal: @paciente.nome_animal, nome_dono: @paciente.nome_dono } }
    end
  ...
  test "should update paciente" do
    patch paciente_url(@paciente), params: { paciente: { cpf_cnpj_dono: @paciente.cpf_cnpj_dono, foto: @paciente.foto, nome_animal: @paciente.nome_animal, nome_dono: @paciente.nome_dono } }
