...
class VeterinariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veterinario" do
    assert_difference('Veterinario.count') do
      post veterinarios_url, params: { veterinario: { cmrv: @veterinario.cmrv, especialidade: @veterinario.especialidade, nome: @veterinario.nome } }
    end
  ...
  test "should update veterinario" do
    patch veterinario_url(@veterinario), params: { veterinario: { cmrv: @veterinario.cmrv, especialidade: @veterinario.especialidade, nome: @veterinario.nome } }
